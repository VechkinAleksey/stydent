...
function feedbackSubmit(){
   ...
   if (document.yslygi.fio.value=="") {
      ...
      if (document.yslygi.adres.value=="") {
      alert("Пожалуйста укажите адрес!");
      document.yslygi.adres.focus();
      return false;
   }     
   
      if (document.yslygi.phone.value=="") {
      alert("Пожалуйста укажите телефон!");
      document.yslygi.phone.focus();
      return false;
   }     
   
     if (document.yslygi.otziv.value=="") {
      alert("Пожалуйста напишите отзыв!");
      document.yslygi.otziv.focus();
      return false;
   }     
...
<h2>Отзыв.</h2>
						...
						<h2><p>Напишите отзыв о магазине, это поможет нам делать работу лучше.</a></p></h2>
						<form name=yslygi action="create2.php" method=POST onSubmit="feedbackSubmit()">
    <TABLE width= 200px cellSpacing=-300px cellPadding=10px  border=0px  style="border-style: dashed; border-width: 1px" bgcolor="#FFE5B6">
	  <TR>
	<TD>ФИО:</TD>
    ...
    <TR>
		<div style="position:absolute; left:320px;top:266px;bottom:0px;right:0px;">
