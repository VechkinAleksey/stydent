...
<div class="shell">
 ...
 <form name="indexform" action="login.php" method="POST" onSubmit="return validate_form ( );">
    ...
    <TD style="PADDING-BOTTOM: 10px" width="99%"><A href="regestrasia.php">Зарегистрироваться</A>
    </TD>
    </TR>
	 </TABLE>
		...
		<div id="main">
			<div id="content" class="left">
				<div class="highlight">
					...
					по этому товару.</p>
					<a href="about.php" class="more">Узнать больше</a>
				</div>
				...
				<div class="projects">
					...
					<div class="item">
						...
						<div class="text left">
							...
							<a href="tovar.php" class="more">Узнать больше</a>
						</div>
						<div class="cl">&nbsp;</div>
					</div>
					<!--next-->
			...
			<div id="sidebar" class="right">
				...
				<div class="sidebar-nav">
					<ul>
					    <li><a href="tovar.php">Купить товар</a></li>
					    <li><a href="kontakti.php">Связатся с продавцом</a></li>
					    <li><a href="otzivi.php">Наисать отзыв</a></li>
					    <li><a href="tovar.php">Посмотреть товар</a></li>
					    <li><a href="services.php">Посмотреть предоставляемы услуги</a></li>
					</ul>
				</div>
				
				<a href="tovar.php" class="btn-buy"><em>Купить </em></a>
