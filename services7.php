...
function feedbackSubmit(){
   ...
   if (document.yslygi.fio.value=="") {
      ...
      if (document.yslygi.id_tovara.value=="") {
      alert("Пожалуйста укажите id_товара!");
      document.yslygi.id_tovara.focus();
      return false;
   }     
...
<h2>Заказ.</h2>
						...
						<h2><p>Для заказа товара напишите информацию и мы с вами свяжимся.</a></p></h2>
						<form name=yslygi action="create4.php" method=POST onSubmit="feedbackSubmit()">
    <TABLE width= 200px cellSpacing=-300px cellPadding=10px  border=0px  style="border-style: dashed; border-width: 1px" bgcolor="#FFE5B6">
	  <TR>
	<TD>ФИО:</TD>
